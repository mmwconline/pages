...
(function() {
	...
	jQuery(document).ready(function(){
		...
		map2.addMarker({
			lat: mmwcLat,
			lng: mmwcLng,
			title: "Milwaukee Muslim Women's Coalition",
			...
			infoWindow: {
				content: "<strong>Milwaukee Muslim Women's Coalition </strong><br>5235 S, 27th Street, Greenfield, WI 53221<br><br><a href='#' onclick='map2.setZoom(15); map2.setCenter(mmwcLat, mmwcLng)'>[+] zoom here</a>"
			}
		});
	});
})();